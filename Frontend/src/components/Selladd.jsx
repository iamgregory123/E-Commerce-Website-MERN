        ...
        <>
            ...
            <Box sx={{ display: 'flex', flexDirection: 'column', marginTop: '30px' }}>
                                ...
                                <Box sx={{ display: 'flex', flexDirection: 'column', backgroundColor: 'white', padding: '16px', borderRadius: '8px', boxShadow: 10 }}>
                                    <Box sx={{ flex: 1 }}>
                                        ...
                                        <Box sx={{display:'flex',flexDirection:'column',alignItems:'center',justifyContent:'center'}}>
                                            ...
                                            <Typography fontWeight={550} sx={{ marginTop: '30px' }}>Price: ${product.price}</Typography>
                                        </Box>
                                    </Box>
                ...
                <Box sx={{ display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
                    <Button
                        onClick={handleOpen}
                        sx={{ color: 'whitesmoke', backgroundColor: '#110074', height: '40px', width: '150px', borderRadius: '15px', cursor: 'pointer', borderColor: 'white', fontWeight: 550 ,margin:'20px'}}
                    >
                        Add Products
                    </Button>
                </Box>
